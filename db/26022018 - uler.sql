...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 26, 2018 at 10:31 AM
...
INSERT INTO `course_forum_thread` (`cft_id`, `cft_title`, `cft_rated`, `cft_timecreated`, `cft_timemodified`, `usr_id`, `cfr_id`) VALUES
(1, 'asdasdf', NULL, NULL, NULL, 3, 2),
(2, 'sdfssdf', NULL, NULL, NULL, 6, 1);
...
(1, 'Mengimplementasikan Klasifikasi Data', '2018-01-31 17:00:00', '2018-01-31 17:00:00', 2),
(2, 'Menjelaskan Klasifikasi Data', '2018-01-31 17:00:00', '2018-01-31 17:00:00', 3);
...
ALTER TABLE `course_enrol`
  ...
  ADD KEY `usr_enrol_foreign` (`usr_id`);
...
ALTER TABLE `course_forum_thread`
  ...
  ADD KEY `user_thread_foreign` (`usr_id`),
  ADD KEY `forum_thread_foreign` (`cfr_id`);
...
ALTER TABLE `course_enrol`
  ...
  ADD CONSTRAINT `usr_enrol_foreign` FOREIGN KEY (`usr_id`) REFERENCES `users` (`usr_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `course_forum_thread`
  ...
  ADD CONSTRAINT `user_thread_foreign` FOREIGN KEY (`usr_id`) REFERENCES `users` (`usr_id`) ON DELETE CASCADE ON UPDATE CASCADE;
