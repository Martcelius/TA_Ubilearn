...
class M_login extends CI_Model{
    ...
    {
        $this->db->select('usr_id,usr_kode,usr_username,usr_firstname,usr_lastname,usr_password,usr_email,usr_picture,usr_gpa,usr_level,usr_jk,usr_tgllahir,usr_tmpasal');
        $this->db->from('users');
    ...
    public function insert()
    {
        ...
        $insert = $this->db->query("INSERT INTO users (usr_username,usr_firstname,usr_lastname,usr_password,usr_email,usr_level,usr_picture,usr_jk,usr_tgllahir,usr_tmpasal) VALUES ('".$data['name_pengguna']."' , '".$data['name_depan']."', '".$data['name_belakang']."', '".$data['pass']."', '".$data['email']."','".$data['level']."','".$data['foto']."',".$data['jenis_kelamin'].",'".$data['tgl_lahir']."','".$data['usr_tempasal']."') ");
