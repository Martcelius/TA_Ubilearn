...
<br>
    ...
    <div style="text-align:left;margin-left: 30px;margin-bottom: 30px;">
        <!-- <a href="<?php echo base_url().'siswa/selfass2/'?>"> -->
            <button onclick="next(2)" id="nextt" style="background-color: #99999;" class="mdl-button mdl-js-button mdl-button--raised">
        Selanjutnya
            </button>
        <!-- </a> -->
    </div>
...
<!-- kuesioner halaman 2 -->
<div class="mdl-card__supporting-text" style="display:none" id="kues2">
    <ol start="12" type="1">
        <h4>
...
<!-- tombol next&prev -->
    <div style="text-align:left;margin-left: 0px;margin-bottom: 30px;">
            <!-- <a href="<?php echo base_url().'siswa/selfass/'?>"> -->
                <button onclick="prev(1)" style="background-color: #99999;" class="mdl-button mdl-js-button mdl-button--raised">
            Sebelumnya
                </button>
            <!-- </a> -->
            <!-- <a href="<?php echo base_url().'siswa/selfass3/'?>"> -->
                <button onclick="next(3)" style="background-color: #99999;" class="mdl-button mdl-js-button mdl-button--raised">
            Selanjutnya
                </button>
            <!-- </a>     -->
            </div>
...
<!-- kuesioner halaman 3 -->
<div class="mdl-card__supporting-text" style="display:none" id="kues3">
            <ol start="23" type="1">
            ...
            <div style="text-align:left;margin-left: 0px;margin-bottom: 30px;">
            <!-- <a href="<?php echo base_url().'siswa/selfass/'?>"> -->
                <button onclick="prev(2)" style="background-color: #99999;" class="mdl-button mdl-js-button mdl-button--raised">
            Sebelumnya
                </button>
            <!-- </a> -->
            <!-- <a href="<?php echo base_url().'siswa/selfass3/'?>"> -->
                <button onclick="next(4)" style="background-color: #99999;" class="mdl-button mdl-js-button mdl-button--raised">
            Selanjutnya
                </button>
            <!-- </a>     -->
            </div>
...
<!-- kuesioner halaman 4 -->
<div class="mdl-card__supporting-text" style="display:none" id="kues4">
            <ol start="34" type="1">
            ...
            <div style="text-align:left;margin-left: 0px;margin-bottom: 30px;">
            <!-- <a href="<?php echo base_url().'siswa/selfass/'?>"> -->
                <button onclick="prev(3)" style="background-color: #99999;" class="mdl-button mdl-js-button mdl-button--raised">
            Sebelumnya
                </button>
            <!-- </a> -->
            <!-- <a href="<?php echo base_url().'siswa/selfass3/'?>"> -->
