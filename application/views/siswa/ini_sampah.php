<main class="mdl-layout__content">
            ...
            <div class="">
                <div class="">
                    ...
                    <div style="text-align:center">
                        <img src="<?php echo base_url(); ?>/res/assets/images/uploads/<?php echo $kontent->usr_picture; ?>"
                             class="material-icons mdl-list__item-avatar" style="width: 100px; height: 100px;">
            ...
            <div class="mdl-card mdl-shadow--2dp pie-chart">
                <div class="mdl-card__supporting-text">
                    ...
                    <ul class="mdl-list" style="margin: 15px;">
                        <a href="<?php echo site_url() ?>res/assets/content/<?php echo $kontent->cnt_source ?>"
                           target="_blank">
    ...
    <!--        <img src="-->
    <?php //echo base_url();?><!--res/assets/images/uploads/avatar_default.jpg" class="img-responsive img-thumbnail" id="blah">            </div>-->
    <!--    </div>-->
