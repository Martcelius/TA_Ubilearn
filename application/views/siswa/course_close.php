        ...
        <div class="mdl-card mdl-shadow--2dp trending">
            ...
            <div class="mdl-card__supporting-text">
                ...
                <div style="text-align:center;">
                    <a href="<?php echo site_url('siswa/my_course/'.$dataCourse->crs_id)?>"><button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--colored-light-blue" >
                        Ambil Course
                    </button></a>
                 </div>
            </div>
