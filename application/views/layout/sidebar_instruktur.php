<header style="background:rgba(230, 230, 230, 0.93)"><img src="<?php echo site_url('res/assets/images/Ubilearning_logo.png')?>" style="height:50px ;width:500px ;"  alt="U-Learning"></header>
        <nav class="mdl-navigation">
            <a style="text-decoration:none;" class="mdl-navigation__link mdl-navigation__link--current" href="<?php echo site_url('instruktur/dashboard')?>">
                <i class="material-icons" role="presentation">dashboard</i>
                Dashboard
            </a>
            <a style="text-decoration:none;" class="mdl-navigation__link" href="<?php echo site_url('instruktur/MyCourse')?> ">
                <i class="material-icons" role="presentation">folder</i>
               My Course
            </a>
            <a style="text-decoration:none;" class="mdl-navigation__link" href="<?php echo site_url('instruktur/forum_instruktur')?>">
                <i class="material-icons" role="presentation">forum</i>
                Forum
            </a>
            <a style="text-decoration:none;" class="mdl-navigation__link" href="<?php echo site_url('instruktur/learning_outcome')?>">
