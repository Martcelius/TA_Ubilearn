<main class="mdl-layout__content">
  <div class="mdl-grid cover-main">
    <div class="mdl-cell mdl-cell--12-col-desktop mdl-cell--12-col-tablet mdl-cell--12-col-phone">
      <div class="">
          <div class="">
              <h2 style="color:white">Tambah Latihan Baru</h2>
          </div>
      </div>
    </div>
  </div>
    ...
    <div class="mdl-cell mdl-cell--12-col-desktop mdl-cell--12-col-tablet mdl-cell--12-col-phone">
      <div class="mdl-card mdl-shadow--2dp pie-chart">
          <div class="mdl-card__title" style="display:block;">
              ...
              <div class="mdl-card__subtitle-text">menambahkan latihan baru</div>
          </div>
          <div class="mdl-card__supporting-text" style="font-size: unset;" >
            <form class="form-horizontal" action="/action_page.php">
        <div class="form-group">
          <label class="control-label col-sm-2" >Nama Latihan :</label>
          <div class="col-sm-10">
            <input type="text" class="form-control" id="nama" name="nama" required placeholder="Masukkan Nama Latihan">
          </div>
        </div>
        <div class="form-group">
          <label class="control-label col-sm-2" >Deskripsi :</label>
          <div class="col-sm-10"> 
            <textarea type="text" class="form-control" rows="5" id="desc" name="desc" placeholder="Masukkan Deskripsi Latihan"></textarea>
          </div>
        </div>
        <div class="form-group">
