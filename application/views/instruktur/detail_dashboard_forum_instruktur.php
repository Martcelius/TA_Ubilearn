<main class="mdl-layout__content">
    ...
    <div class="mdl-grid">
        ...
        <?php endif; ?>
        <div class="mdl-cell mdl-cell--12-col-desktop mdl-cell--12-col-tablet mdl-cell--12-col-phone">
        <a href="<?php echo site_url('instruktur/add_forum/'.$datalesson->lsn_id)?>">
                        ...
                        foreach ($dataForum as $forum):?>
                            <tr>
                                ...
                                <td style="text-align: center;">
                                  ...
                                  <a href="<?php echo site_url('instruktur/edit_forum/'.$forum->cfr_id.'/'.$forum->lsn_id)?>">
                                  ...
                                  <a href="<?php echo site_url('instruktur/forum/delete_forum/'.$forum->cfr_id.'/'.$forum->lsn_id)?>">
