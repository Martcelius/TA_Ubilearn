...
$route['siswa/detail_thread_siswa/(:any)'] = 'siswa/thread/detail_thread_siswa/$1';
//assesment
...
$route['instruktur/add_forum/(:any)/(:any)'] = 'instruktur/forum/add_forum/$1/$2';
$route['instruktur/insert_forum/(:any)/(:any)'] = 'instruktur/forum/insert_forum/$1/$2';
